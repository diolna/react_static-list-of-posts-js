 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(k,E){var C=k.length;k.push(E);e:for(;0<C;){var V=C-1>>>1,J=k[V];if(0<a(J,E))k[V]=E,k[C]=J,C=V;else break e}}function i(k){return k.length===0?null:k[0]}function n(k){if(k.length===0)return null;var E=k[0],C=k.pop();if(C!==E){k[0]=C;e:for(var V=0,J=k.length,Xi=J>>>1;V<Xi;){var qt=2*(V+1)-1,ha=k[qt],yt=qt+1,Zi=k[yt];if(0>a(ha,C))yt<J&&0>a(Zi,ha)?(k[V]=Zi,k[yt]=C,V=yt):(k[V]=ha,k[qt]=C,V=qt);else if(yt<J&&0>a(Zi,C))k[V]=Zi,k[yt]=C,V=yt;else break e}}return E}function a(k,E){var C=k.sortIndex-E.sortIndex;return C!==0?C:k.id-E.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;e.unstable_now=function(){return u.now()}}else{var o=Date,r=o.now();e.unstable_now=function(){return o.now()-r}}var s=[],m=[],v=1,f=null,p=3,h=!1,g=!1,b=!1,j=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,l=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function c(k){for(var E=i(m);E!==null;){if(E.callback===null)n(m);else if(E.startTime<=k)n(m),E.sortIndex=E.expirationTime,t(s,E);else break;E=i(m)}}function q(k){if(b=!1,c(k),!g)if(i(s)!==null)g=!0,qa(I);else{var E=i(m);E!==null&&ya(q,E.startTime-k)}}function I(k,E){g=!1,b&&(b=!1,d(_),_=-1),h=!0;var C=p;try{for(c(E),f=i(s);f!==null&&(!(f.expirationTime>E)||k&&!Ee());){var V=f.callback;if(typeof V=="function"){f.callback=null,p=f.priorityLevel;var J=V(f.expirationTime<=E);E=e.unstable_now(),typeof J=="function"?f.callback=J:f===i(s)&&n(s),c(E)}else n(s);f=i(s)}if(f!==null)var Xi=!0;else{var qt=i(m);qt!==null&&ya(q,qt.startTime-E),Xi=!1}return Xi}finally{f=null,p=C,h=!1}}var w=!1,S=null,_=-1,$=5,P=-1;function Ee(){return!(e.unstable_now()-P<$)}function ri(){if(S!==null){var k=e.unstable_now();P=k;var E=!0;try{E=S(!0,k)}finally{E?si():(w=!1,S=null)}}else w=!1}var si;if(typeof l=="function")si=function(){l(ri)};else if(typeof MessageChannel<"u"){var Lo=new MessageChannel,mm=Lo.port2;Lo.port1.onmessage=ri,si=function(){mm.postMessage(null)}}else si=function(){j(ri,0)};function qa(k){S=k,w||(w=!0,si())}function ya(k,E){_=j(function(){k(e.unstable_now())},E)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(k){k.callback=null},e.unstable_continueExecution=function(){g||h||(g=!0,qa(I))},e.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<k?Math.floor(1e3/k):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return i(s)},e.unstable_next=function(k){switch(p){case 1:case 2:case 3:var E=3;break;default:E=p}var C=p;p=E;try{return k()}finally{p=C}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(k,E){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var C=p;p=k;try{return E()}finally{p=C}},e.unstable_scheduleCallback=function(k,E,C){var V=e.unstable_now();switch(typeof C=="object"&&C!==null?(C=C.delay,C=typeof C=="number"&&0<C?V+C:V):C=V,k){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=C+J,k={id:v++,callback:E,priorityLevel:k,startTime:C,expirationTime:J,sortIndex:-1},C>V?(k.sortIndex=C,t(m,k),i(s)===null&&k===i(m)&&(b?(d(_),_=-1):b=!0,ya(q,C-V))):(k.sortIndex=J,t(s,k),g||h||(g=!0,qa(I))),k},e.unstable_shouldYield=Ee,e.unstable_wrapCallback=function(k){var E=p;return function(){var C=p;p=E;try{return k.apply(this,arguments)}finally{p=C}}}})(is);ts.exports=is;var Tm=ts.exports;/**
 * @license React
...
aut aut aut maxime quia temporibus ut omnis`}],lm=({posts:e})=>F.jsx("div",{className:"PostList",children:e.map(t=>{const i=$c.filter(a=>a.postId===t.id),n={...t,comments:i};return F.jsx(sm,{post:n},t.id)})});lm.propTypes={posts:N.arrayOf(N.shape({id:N.number.isRequired,userId:N.number.isRequired,title:N.string.isRequired,body:N.string.isRequired})).isRequired};const Vc=[{id:1,userId:1,title:"sunt aut facere repellat provident occaecati excepturi optio reprehenderit",body:`quia et suscipit
...
expedita consequatur consequatur dolores quia eos et placeat`}],Wc=()=>F.jsxs("section",{className:"App",children:[F.jsx("h1",{className:"App__title",children:"Static list of posts"}),F.jsx(lm,{posts:Vc})]});tm(document.getElementById("root")).render(F.jsx(Wc,{}));
