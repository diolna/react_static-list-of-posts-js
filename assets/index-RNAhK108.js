...
aut aut aut maxime quia temporibus ut omnis`}],Mc=({posts:e})=>O.jsx("div",{className:"PostList",children:e.map(t=>{const i=Tc.filter(a=>a.postId===t.id),n={...t,comments:i};return O.jsx(Lc,{post:n},t.id)})}),Rc=[{id:1,userId:1,title:"sunt aut facere repellat provident occaecati excepturi optio reprehenderit",body:`quia et suscipit
...
expedita consequatur consequatur dolores quia eos et placeat`}],Dc=()=>O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Mc,{posts:Rc})]});em(document.getElementById("root")).render(O.jsx(Dc,{}));
